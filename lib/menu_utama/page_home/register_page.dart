...
class register_page_ extends StatefulWidget {
  const register_page_({Key? key}) : super(key: key);
  @override
  _login_page_State createState() => _login_page_State();
}

class _login_page_State extends State<register_page_> {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text("Kalau belum punya akun register dulu",
